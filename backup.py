"""
Backup 1.0.1
(Эта версия программы была отредактирована через git)

Программа создает резервную копию данных, путем помещения их в .zip-архив.
Директории необходимых каталогов принимаются с помощью пользовательского ввода.
"""
